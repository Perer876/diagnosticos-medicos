    ...
    <x-slot name="header">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Agrega o actualiza signos de la enfermedad en cuestion</p>
            </div>
    ...
    <section class="section row justify-content-center">
        <div class="card col-12 col-md-10 col-xl-8">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form" method="post" action="{{ route('enfermedades.update-signo', $enfermedade) }}">
                        @method('PATCH')
                        @csrf                        
                        <div class="form-group">
                            ...
                            <select class="form-select" multiple="multiple" name="signos[]" id="signosInput"
                                ...
                                @foreach(\App\Models\Signo::pluck('nombre', 'id') as $id => $nombre)
                                    <option value="{{ $id }}" @selected($enfermedade->signos->contains($id))>
                                        {{ $nombre }}
                                    </option>
                                @endforeach
                            </select>
